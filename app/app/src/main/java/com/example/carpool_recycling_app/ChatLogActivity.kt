    ...
    private fun performSendMessage(){
        ...
        reference.setValue(chatMessage)
            .addOnSuccessListener {
                ...
                edittext_chat_log.text.clear() // clear text after sending
                recyclerview_chat_log.scrollToPosition(adapter.itemCount - 1) // scrolls to the bottom of the recycler view
            }
